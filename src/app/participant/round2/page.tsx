...
import { getRound2Snippets, Round2Snippet, runRound2Tests, TestCaseResult, submitRound2, Participant, getInstructions, getEventStatus, EventStatus, getParticipant } from '@/app/actions';
...
export default function ParticipantRound2() {
    ...
    const handleSubmitRound = useCallback(async () => {
        ...
        try {
            const { score, total, passed } = await submitRound2(participant.id, finalSubmissions, timeTaken);
    ...
    }, [isLoading, snippets.length, isSubmitting, roundStarted]);
                             ...
                             <div className="flex items-center gap-4">
                                ...
                                <AlertDialog>
                                    <AlertDialogTrigger asChild>
                                        <Button disabled={isSubmitting || isLoading}>Submit Round 2</Button>
                                    </AlertDialogTrigger>
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {resultData.passed
                                ? " You have qualified for Round 3!"
                                : " You have not met the 50% requirement to advance to the next round."}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
